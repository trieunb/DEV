...
$(function() {
    ...
    function containerHeight() {
        var availableHeight = $(window).height() - $('.page-container').offset().top - $('.navbar-fixed-bottom').outerHeight() - 2;
    ...
    // VuongVT - 2016/12/16 - event click for icon of group item
    $('.icon-circle-down2').click(function (e) {
        e.preventDefault();
        $(this).toggleClass('rotate-180');
    });
