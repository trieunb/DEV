...
class InternalOrderSearchController extends Controller
{
	...
	{		
		try {
            ...
            return view('manufactureinstruction::InternalOrderSearch.search', compact('paginate', 'fillter', 'manufacture_status_div'));
        } catch (\Exception $e) {
    ...
    */
    public function postSearch(Request $request){
        try{
            ...
            $html          = view('manufactureinstruction::InternalOrderSearch.list',compact('internalList','paginate', 'fillter'))->render();
            //return data
