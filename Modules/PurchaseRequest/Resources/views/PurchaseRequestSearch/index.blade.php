...
@section('button')
	{{Button::button_left(array('btn-search', 'btn-add-new', 'btn-issue','btn-export','btn-approve'))}}
@endsection

@section('stylesheet')
	{!! public_url('modules/purchase/css/purchase_request_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/purchase/js/purchase_request_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		<div class="panel panel-flat">
			...
			<div class="panel-body search-condition">
				...
				<div class="form-group">
					<label class="col-md-2 control-label text-right text-bold">購入依頼日</label>
		...
		<div id="purchase-request-list">
			@includeIf('purchaserequest::PurchaseRequestSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
@endsection