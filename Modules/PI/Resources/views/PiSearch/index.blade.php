...
@section('button')
	{{Button::button_left(array('btn-search', 'btn-add-new', 'btn-print', 'btn-approve', 'btn-export'))}}
@endsection

@section('stylesheet')
	{!! public_url('modules/pi/css/pi_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/pi/js/pi_search.js')!!}
@endsection
...
<div class="row form-horizontal">
	...
	<!-- List PI -->
	<div id="pi-list">
		@includeIf('pi::PiSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
	</div>
</div>
@endsection
