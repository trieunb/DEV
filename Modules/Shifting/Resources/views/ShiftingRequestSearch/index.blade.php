...
@section('stylesheet')
	{!! public_url('modules/shifting/css/shifting_request_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/shifting/js/shifting_request_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		<div id="div-shifting-list">
			@includeIf('shifting::ShiftingRequestSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
