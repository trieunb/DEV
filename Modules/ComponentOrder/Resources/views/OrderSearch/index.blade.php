...
@section('page_javascript')
	{!! public_url('modules/componentorder/js/order_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		<!-- /search field -->
		<input type="hidden" id="report_number_parts_order" value="{{ $report_number_parts_order or '' }}">
		<div id="component-order-list">
			@includeIf('componentorder::OrderSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
@endsection