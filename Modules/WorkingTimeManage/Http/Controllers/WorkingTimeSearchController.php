    ...
    */
    public function index()
    {
        try {
            ...
            return view('workingtimemanage::WorkingTimeSearch.index',compact('paginate', 'fillter'));
        } catch (\Exception $e) {
    ...
    */
    public function postSearch(Request $request){
        try{
            ...
            $fillter            = $paginator->fillter();
            $html               = view('workingtimemanage::WorkingTimeSearch.list',compact('workingtimeList','paginate', 'fillter'))->render();
            //return data
