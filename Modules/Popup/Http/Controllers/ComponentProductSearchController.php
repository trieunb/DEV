...
class ComponentProductSearchController extends Controller
{
    /**
    * list pi
    * -----------------------------------------------
    ...
    */
    public function getSearch()
    {
        try {
            ...
            return view('popup::ComponentProductSearch.index', compact('paginate', 'fillter'));
        } catch (\Exception $e) {
            return response()->json(array('response'=>false));
        }
    }
    /**
    * search component product
    * -----------------------------------------------
    ...
    */
    public function postSearch(Request $request) {
        try {
            ...
            $html           = view('popup::ComponentProductSearch.list',compact('List','paginate', 'fillter'))->render();
