    ...
    */
    public function getSearch()
    {
        try {
            ...
            return view('popup::ProductMasterSearch.index', compact('paginate', 'fillter'));
        } catch (\Exception $e) {
    ...
    */
    public function postSearch(Request $request){
        try{
            ...
            $fillter       = $paginator->fillter();
            $html          = view('popup::ProductMasterSearch.list',compact('productList','paginate', 'fillter'))->render();
            //return data
