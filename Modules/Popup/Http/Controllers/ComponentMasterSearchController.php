    ...
    */
    public function getSearch()
    {
        try {
            ...
            return view('popup::ComponentMasterSearch.index', compact('paginate', 'fillter'));
        } catch (\Exception $e) {
    ...
    */
    public function postSearch(Request $request){
        try{
            ...
            $fillter       = $paginator->fillter();
            $html          = view('popup::ComponentMasterSearch.list',compact('componentList','paginate', 'fillter'))->render();
            //return data
