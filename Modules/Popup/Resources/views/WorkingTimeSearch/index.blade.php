...
@section('stylesheet')
	{!! public_url('modules/popup/css/working_time_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/working_time_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		<div id="popup_workingtime_list">
			@includeIf('popup::WorkingTimeSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
@endsection