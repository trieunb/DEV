...
@section('stylesheet')
	{!! public_url('modules/popup/css/accept_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/accept_search.js')!!}
@endsection
...
@section('content')
	<div class="row form-horizontal">
		...
		<div class="panel panel-flat">
			...
			<div class="panel-body search-condition">
				...
				<div class="form-group">
					...
					<div class="col-md-1">
						<input type="text" name="TXT_rcv_no" class="form-control TXT_rcv_no" maxlength="10" style="min-width: 150px;">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="TXT_cust_nm" class="form-control TXT_cust_nm" value="">
					</div>
				</div>
		...
		<div id="rcv-list">
			@includeIf('popup::AcceptSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
@endsection