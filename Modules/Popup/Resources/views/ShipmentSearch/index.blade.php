...
@section('stylesheet')
	{!! public_url('modules/popup/css/shipment_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/shipment_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		@includeIf('popup::ShipmentSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
	</div>
