			...
			<div class="table-responsive table-custom">
				<table class="table table-hover table-bordered table-xxs table-list table-shipment tablesorter" id="table-shipment">
					...
					<tr class="col-table-header text-center">
						...
						<th class="text-center" width="6%">出荷指示NO</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-left DSP_fwd_no shipment_cd">{{ $val['fwd_no'] or '' }}</td>
							<td class="text-left">{{ $val['fwd_detail_no'] or '' }}</td>
							...
							<td class="text-right">{{ $val['fwd_qty'] or '' }}</td>
