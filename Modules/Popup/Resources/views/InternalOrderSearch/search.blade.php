...
@section('button')
	{{Button::button_left(array('btn-search', 'btn-add-new', 'btn-print'))}}
@endsection

@section('stylesheet')
	{!! public_url('modules/popup/css/search_internal_order.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/search_internal_order.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
			...
			<div class="panel-body search-condition">
				...
				<div class="form-group">
					...
					<div class="col-md-6 date-from-to">
						<input type="text" class="form-control number-date TXT_order_date_no_from" name="number-date" style="display: inline;" value="" >
						<input value="" type="tel" class="datepicker form-control date-from TXT_order_date_from" name="TXT_order_date_from">
						<span class="">～</span>
		
						<input type="text" class="form-control number-date TXT_order_date_no_to" name="number-date" style="display: inline;" value="">
						<input value="" type="tel" class="datepicker form-control date-to TXT_order_date_to" name="TXT_date_to">
					</div>
				</div>
				<div class="form-group">
		...
		<div id="div-internal-list">
			@includeIf('popup::InternalOrderSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
	</div>
