			...
			<div class="table-responsive table-custom ">
				<table class="table table-hover table-bordered table-xxs table-list table-pi tablesorter" id="table-pi">
					...
					<tr class="col-table-header text-center">
						...
						<th class="text-center" width="2%">受注 No</th>
						<th class="text-center th-date" width="5%">見積日</th>
						<th class="text-center" width="5%">取引先コード</th>
						<th class="text-center" width="7%">取引先名</th>
						<th class="text-center" width="2%">国</th>
						<th class="text-center" width="3%">Code</th>
						<th class="text-center" width="5%">Item Name</th>
						<th class="text-center" width="4%">Unit Price</th>
						<th class="text-center" width="3%">Q'ty</th>
						<th class="text-center" width="2%">Cur</th>
						<th class="text-center" width="3%">Amount</th>
						<th class="text-center" width="3%">ステータス</th>
					</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="text-left pi_cd DSP_pi_no">{{$pi['pi_no'] or ''}}</td>
							...
							<td class="text-right DSP_currency_div">{{$pi['currency_div'] or ''}}</td>
							<td class="text-right DSP_qty_unit_price">{{$pi['qty_unit_price'] or ''}}</td>
							<td class="text-right DSP_pi_status_nm">{{$pi['pi_status_nm'] or ''}}</td>
						</tr>
						@endforeach
					@else
					<tr>
