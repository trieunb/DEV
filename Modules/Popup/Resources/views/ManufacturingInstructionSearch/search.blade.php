...
@section('stylesheet')
	{!! public_url('modules/popup/css/manufacturing_instruction_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/manufacturing_instruction_search.js')!!}
@endsection
...
@section('content')
	...
	<div class="row form-horizontal">
		...
		<div id="div-manufactor-search-list">
			@includeIf('popup::ManufacturingInstructionSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
	</div>
