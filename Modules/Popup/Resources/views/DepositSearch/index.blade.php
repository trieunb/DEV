...
@section('stylesheet')
	{!! public_url('modules/popup/css/deposit_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/popup/js/deposit_search.js')!!}
@endsection
...
@section('content')
	<div class="row form-horizontal">
		...
		<!-- List deposit -->
		<div id="deposit-list">
			@includeIf('popup::DepositSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
	</div>
