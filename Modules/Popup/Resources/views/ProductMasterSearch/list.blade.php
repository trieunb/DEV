					...
					<tbody  class="results">
						@if(isset($productList) && !empty($productList))
							@foreach($productList as $row)
								<tr class="tr-table">
									<td class="text-left sticky-cell th-first product_cd DSP_product_cd">{{$row['product_cd']}}</td>
									...
									<td class="text-left DSP_jan_code">
										<div class="tooltip-overflow max-width20" data-toggle="tooltip" data-placement="top" title="{{$row['jan_code']}}">{{$row['jan_code']}}
									</td>
