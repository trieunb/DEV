...
@section('stylesheet')
	{!! public_url('modules/shipment/css/shipment_detail.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/shipment/js/shipment_detail.js')!!}
@endsection
	...
	<div class="row form-horizontal">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title text-bold">@lang('title.shipment-detail')</h5>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-md-1 col-md-1-cus control-label text-right text-bold required">出荷指示No</label>
					<div class="col-md-3">
						@includeIf('popup.searchshipment', array(
							'id'          => 'TXT_fwd_no',
							'is_required' => false,
							'is_nm'		  => false,
							'key' 		  => isset($shipment_no) ? $shipment_no : ''))
					</div>
				...
				<div class="form-group">
					<label class="col-md-1 col-md-1-cus control-label text-right text-bold required">ユーザートレーニングの確認</label>
					<div class="col-md-1">
						<select class="form-control user_training_check_div CMB_user_training_check_div required" id="CMB_user_training_check_div" name="CMB_user_training_check_div" data-ini-target=true>
							<option></option>
							@if(isset($user_training_check_div))
								@foreach($user_training_check_div as $k=>$v)
									<option value="{{$v['lib_val_cd']}}" 
											data-ctl1="{{$v['lib_val_ctl1']}}" data-ctl2="{{$v['lib_val_ctl2']}}"
											data-ctl5="{{$v['lib_val_ctl5']}}" data-ctl6="{{$v['lib_val_ctl6']}}"
											data-nm-j="{{$v['lib_val_nm_j']}}" data-nm-e="{{$v['lib_val_nm_e']}}"
				...
				<div class="table-responsive sticky-table sticky-headers sticky-ltr-cells">
					@includeIf('shipment::ShipmentDetail.table')
				</div>
				<div class="form-group clearfix" style="border-top: 1px solid #ddd"></div>
				<div class="form-group">
				...
				<span class="STT_temp hide">10</span>
				<span class="out_warehouse_div hide"></span>
				<span class="TXT_mode hide"></span>
			</div>
		<!-- /search field -->
	</div>
		...
		<tbody id="table-row">
			<tr class="">
				...
				<td class="text-center">
			     	@includeIf('popup.searchshipmentserial', array(
														'is_nm' 		=> false,
														'is_required' 	=> false,
														'class_cd'		=> 'TXT_instructed_amount'
														))
					<span class="list_serial hide"></span>
			    </td>
