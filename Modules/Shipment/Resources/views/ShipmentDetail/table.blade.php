<table class="table table-hover table-bordered table-xxs table-text table-shipment table-list table-shipment-detail" id="table-shipment-detail">
	<thead>
	...
	<tbody>
		...
		<tr class="">
			...
			<td class="text-center">
				@if($row['serial_management_div'] == '0')
				...
				@endif
		     	<span class="list_serial hide">{{ $row['serial_list'] or '' }}</span>
		    </td>
