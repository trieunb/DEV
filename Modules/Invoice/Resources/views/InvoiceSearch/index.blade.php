...
@section('button')
	{{Button::button_left(array('btn-search', 'btn-add-new','btn-invoice', 'btn-delivery-note', 'btn-export'))}}
@endsection

@section('stylesheet')
	{!! public_url('modules/invoice/css/invoice_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/invoice/js/invoice_search.js')!!}
@endsection
