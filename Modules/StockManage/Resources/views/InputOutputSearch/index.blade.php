...
@section('stylesheet')
	{!! public_url('modules/stockmanage/css/input_output_search.css')!!}
@endsection

@section('page_javascript')
	{!! public_url('modules/stockmanage/js/input_output_search.js')!!}
@endsection
...
@section('content')
	<div class="row form-horizontal">
		...
		@includeIf('stockmanage::InputOutputSearch.list', ['paginate' => $paginate, 'fillter' => $fillter])
		</div>
		<input type="file" name="upload-excel" class="hidden" id="upload-excel" tabindex="5">
	</div>
@endsection
