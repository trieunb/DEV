...
class ProductMasterSearchController extends Controller
{
    /**
    * list pi
    * -----------------------------------------------
    ...
    */
    public function getSearch()
    {
        try {
            ...
            return view('master::ProductMasterSearch.index', compact('paginate', 'fillter'));
        } catch (\Exception $e) {
    ...
    */
    public function postSearch(Request $request){
        try{
            ...
            $productList    = isset($data[0]) ? $data[0] : array();
            ...
            $fillter       = $paginator->fillter();
            $html          = view('master::ProductMasterSearch.list',compact('productList','paginate', 'fillter'))->render();
            //return data
