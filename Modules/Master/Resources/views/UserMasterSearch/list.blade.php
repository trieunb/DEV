<div id="result" class="row panel panel-flat">
	...
	<div class="panel-body">
		<div class="no-padding">
			...
			<div class="table-responsive">
				<table class="table table-hover table-bordered table-xxs table-text table-user tablesorter table-list" id="table-user">
					<thead>
